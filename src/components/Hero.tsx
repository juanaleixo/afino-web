      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg text-muted-foreground sm:text-xl leading-relaxed animate-fade-in-up delay-300 max-w-3xl mx-auto">
            ...
            com gráficos organizados e relatórios personalizados.
          </p>
        ...
        <div className="mt-20 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 animate-fade-in-up delay-600">
          <Card className="card-hover border-0 bg-gradient-to-br from-card/50 to-card backdrop-blur-sm shadow-lg">
            <CardContent className="p-6">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-card to-card/80 shadow-inner">
              ...
              <h3 className="mb-2 text-lg font-semibold">Dashboard Unificado</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Visualize todos seus investimentos registrados em um só lugar
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="card-hover border-0 bg-gradient-to-br from-card/50 to-card backdrop-blur-sm shadow-lg">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Acompanhe a evolução dos seus saldos registrados dia a dia
              </p>
            </CardContent>
          </Card>
